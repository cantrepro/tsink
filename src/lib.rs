...
pub use storage::{
    ...
    MetricSeries, QueryExecutionAccounting, QueryObservabilitySnapshot, QueryOptions,
    QueryRowsExecutionResult, QueryRowsPage, QueryRowsScanOptions, RemoteSegmentCachePolicy,
    RemoteStorageObservabilitySnapshot, ResolvedResourceLimits, ResourceConfigurationSnapshot,
    ResourceLimitOverride, ResourceLimits, ResourceProfile, ResourceProfileName,
    RetentionObservabilitySnapshot, RollupObservabilitySnapshot, RollupPolicy, RollupPolicyStatus,
    RowWriteOutcome, RowWriteStatus, SelectManyExecutionResult, SelectSeriesExecutionResult,
    SeriesMatcher, SeriesMatcherOp, SeriesPoints, SeriesSelection, SeriesSelectionPreparation,
    SeriesSelectionPreparationError, SeriesSelectionValidationError, ShardWindowDigest,
    ShardWindowRowsExecutionResult, ShardWindowRowsPage, ShardWindowScanOptions, Storage,
    StorageBuilder, StorageObservabilitySnapshot, StorageRuntimeMode, TimestampPrecision,
